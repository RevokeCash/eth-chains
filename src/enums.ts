export enum ChainName {
  ...
  '(deprecated)OptimismonGC' = '(deprecated) Optimism on GC',
  Bobaopera = 'Bobaopera',
  ...
  MorphismTestnet = 'Morphism Testnet',
  'K-LAOS' = 'K-LAOS',
  ...
  RethereumMainnet = 'Rethereum Mainnet',
